...
var XRX_SECURITY_HEADER = '<wsa:Action>[Action]</wsa:Action><wsa:MessageID>[MessageId]</wsa:MessageID>'
    ...
    + '<wsse:Security env:mustUnderstand="true"><wsu:Timestamp wsu:Id="[TimestampId]"><wsu:Created>[Created]</wsu:Created>'
...
{
	return xrxReplaceChars(envelope, '</env:Header>', getSecurityHeader( admin, adminPassword, action, to ) + '</env:Header>' )
