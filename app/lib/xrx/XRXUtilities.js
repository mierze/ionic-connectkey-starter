...
/**
* This function initiates a DomAttrEvent for use in our Second Generation browser which lacks this event.
*
...
/**
* This function gets values from local storage IF we are using the Second Gen Browser.
*
...
/**
* This function sets the value into local storage IF we are using the Second Gen Browser.
*
* @param	key					key string to retreive value
...
/**
* This function calls the high level Ajax function in the XRXJavascript Library.
*
...
/**
* This function calls the low level Ajax function in the XRXJavascript Library.
*
* @param	url					destination address
* @param	envelope			xml string for body of message
